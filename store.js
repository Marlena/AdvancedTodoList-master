...
ListStore = {
  ...
  loadItems: function() {
    var loadRequest = $.ajax({
      type: 'GET',
      url: "https://listalous.herokuapp.com/lists/badTurtle/"
    });
  ...
  addItem: function(itemDescription) {
    var creationRequest = $.ajax({
      type: 'POST',
      url: 'http://listalous.herokuapp.com/lists/badTurtle/items',
  ...
  toggleCompleteness: function(itemId) {
    ...
    var updateRequest = $.ajax({
      type: 'PUT',
      url: 'https://listalous.herokuapp.com/lists/badTurtle/items/' + itemId,
